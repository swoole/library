...
- PHPStan should run against a ZTS build of Swoole (CI uses the `phpswoole/swoole:6.1-php8.3-zts` image); on an NTS build it reports a false "Constant SWOOLE_THREAD not found" error for `src/core/RemoteObject/Server.php`.
